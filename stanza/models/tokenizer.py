...
def parse_args(args=None):
    ...
    parser.add_argument('--sent_drop_prob', type=float, default=0.0, help="Probability to drop sentences at the end of batches during training uniformly at random")
